    ...
    >
      ...
      >
        ...
        <p className="mt-[24px] font-normal sm:text-[24px] text-[18px] sm:leading-[45px] leading-[39px] text-white">
          The Metaverse has given birth to an entirely new and exciting
          industry. We are proud to be at the frontier of innovation with
          MTAVRS. Today, you have the power to become anything you want in any
          world you want.
        </p>
      </motion.div>
      <motion.div
